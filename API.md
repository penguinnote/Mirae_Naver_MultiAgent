...
**가용성** — systemd `Restart=always`와 nginx 리버스 프록시로 운영합니다. 기동 시 BM25 인덱스(72MB)와 Chroma를 미리 로딩해 첫 요청이 지연되지 않습니다. 심사 대상 코드 커밋은 `7093b33`입니다.
