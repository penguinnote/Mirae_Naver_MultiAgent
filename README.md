...
운영 기간: 2026-09-07 ~ 09-30
심사 대상 코드 커밋: `af91008` (배포 서버가 이 해시로 동작합니다. 이후 커밋은 문서 전용입니다)
...
이후 주최 측 공개 예시 질의 5문항으로 4차 검증을 수행해 치명 1건과 중대 1건을 추가로 고쳤습니다. 응답 근거에 색인되지 말았어야 할 문서가 섞여 나가던 문제와, 검색되지 않은 펀드 위험등급을 모델이 임의로 채우던 문제입니다. 두 수정 모두 평가 50문항에서 회귀 0건이며, 배포 코드 `af91008`에 반영돼 있습니다. 상세는 기술제안서 7.3절에 있습니다.
