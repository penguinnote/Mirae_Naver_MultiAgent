...
| 평가셋 | 문항 | 회차 | 결과 | 측정일 |
|---|---:|---|---|---|
| `gold_holdout_v4` (가중 종합) | 24 | **4회**(최종 코드) | **82.3~84.7% (중앙값 83.9%)** — freeze 74.9%(같은 셋 · 1회 · 09-01) 대비 개선 | 2026-09-03 |
| `evalset_v1` 정답률/근거 제공률 | 40 | 2회(최종 코드) | 92.5~95.0% / 97.5% | 2026-09-03 |
| `evalset_v2` | 22 | 1회 | 90.9% / 100.0% | 2026-09-03 |
| `evalset_v4_stress_36` | 36 | 1회 | 80.6% / 83.3% | 2026-09-03 |
| `evalset_ext30` | 30 | 1회 | 93.3% / 86.7% | 2026-09-03 |
