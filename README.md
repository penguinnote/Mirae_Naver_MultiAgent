...
| 평가셋 | 문항 | 회차 | 결과 | 측정일 |
|---|---:|---|---|---|
| `gold_holdout_v4` (가중 종합) | 24 | **3회** | **80.5~81.2% (중앙값 81.2%)** — freeze 74.9%(같은 셋 · 1회 · 09-01) 대비 개선 | 2026-09-03 |
| `evalset_v1` 정답률/근거 제공률 | 40 | 2회 | 80.0~82.5% / 95.0% | 2026-09-03 |
...
| 배포 API (외부, v1 40문항) | 40 | 4회 | 77.5~85.0% / 95.0% (최종 80.0% / 95.0%) | 2026-09-03 |
