...
미래에셋증권 AI Festival 출품작. **RAG + 멀티에이전트 연금 상담 시스템**입니다.
...
| 평가셋 | 문항 | 회차 | 결과 | 측정일 |
|---|---:|---|---|---|
| 홀드아웃 v4 (가중 종합) | 24 | **3회** | **79.1~81.5% (중앙값 79.1%)** — freeze 74.9%(1회) 대비 개선 | 2026-09-03 |
| `evalset_v1` 정답률/근거 제공률 | 40 | 2회 | 77.5~82.5% / 95.0% | 2026-09-03 |
| `evalset_v2` | 22 | 1회 | 86.4% / 100.0% | 2026-09-02 |
| v4 stress | 36 | 1회 | 80.6% / 80.6% | 2026-08-31 |
| ext30 | 30 | 1회 | 90.0% / 73.3% | 2026-08-31 |
| 배포 API (외부, v1 40문항) | 40 | 3회 | 77.5~85.0% / 95.0% | 2026-09-02 |
